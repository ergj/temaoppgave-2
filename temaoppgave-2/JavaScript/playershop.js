...
function addItemToCart(title, price, imageSrc) {
    ...
    for (var i = 0; i < cartItemNames.length; i++) {
        if (cartItemNames[i].innerText == title) {
            alert('Denne spilleren er allererde i din handlekurv!')
            return
        }
    }
    var cartRowContents = `
        ...
        <div class="cart-quantity cart-column">
            ...
            <button class="btn-danger" type="button">Fjern</button>
        </div>`
...
function updateCartTotal() {
    ...
    document.getElementsByClassName('cart-total-price')[0].innerText = '€' + total + 'millioner'
};
